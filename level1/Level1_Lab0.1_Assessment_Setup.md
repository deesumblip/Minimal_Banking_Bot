...
Complete **Lab 0.1** (Steps 1–6 in the lab guide). In short:
...
3. **Step 3:** Install Rasa Pro: `pip install rasa-pro`.
...
- Project structure present in `level1/` (`domain/`, `data/`, and `config.yml`, `credentials.yml`, `endpoints.yml`) — see lab Step 6 for expected file tree
