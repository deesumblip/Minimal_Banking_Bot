...
Test your bot with multiple phrasings so you see how the LLM matches different user messages to the same flow:
...
For each test, note: what you said, which flow triggered, what the bot replied, and whether it matched your expectations. That makes it easier to spot when the wrong flow runs or a response is off.
