You have completed the Minimal Banking Bot course through Level 6. Possible directions beyond the course:
...
- **Channels and deployment** — Deploy the bot with Rasa, action server, and MCP server in your target environment.
- **Rasa documentation** — Explore advanced orchestration, A2A, and MCP in the official Rasa docs.

Your Level 6 bot demonstrates orchestration with one ReAct sub-agent and MCP tools — a solid base to build on.
