...
**Placement.** Level 6 Unit 5 — page **5.2 Testing and Lab 5.2** (merged testing + completion check).
...
**Codio guide (Level 6).** The merged 5.2 page includes: `{Check It!|assessment}(code-output-compare-501060005)`.
