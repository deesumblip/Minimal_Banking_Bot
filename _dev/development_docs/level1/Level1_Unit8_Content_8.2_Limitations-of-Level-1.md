...
**Why this matters**: Level 1 is deliberately simple. Knowing its limits helps you decide when to stay here for information-only agents and when to move to Level 2 for custom code or Level 3 for memory. You're not missing something; you're choosing the right level for the problem.
