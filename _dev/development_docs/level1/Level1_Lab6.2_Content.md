...
**Why this lab**: Training produces a model; Inspector lets you talk to it. You confirm that flows trigger and responses look right before you rely on the agent in later units.
