...
**Lab 6.1** walks through training with step-by-step notes for Codio and for a local machine. You will confirm that the model file was created and you will run the assessment. After that, section **6.2** and the rest of the unit focus on testing slot collection and slot state so you can debug your agent.
