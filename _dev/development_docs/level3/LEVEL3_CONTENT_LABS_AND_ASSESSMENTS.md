...
| File | Purpose |
|------|---------|
| `Level3_Unit0_Content_0.1_Your-Level-2-Banking-Agent.md`, `0.2_What-Level-3-Adds.md` | Unit 0: Recap - What you built in Level 2; what Level 3 adds (slots, check_balance) |
