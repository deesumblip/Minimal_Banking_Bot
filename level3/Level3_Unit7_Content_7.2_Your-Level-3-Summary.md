...
Your bot can do all Level 1 and Level 2 capabilities: responses, flows, and actions. It can remember user-provided information in slots and ask for missing information and use it in actions, such as checking the balance for an account.
