...
- **Codio guide (already populated)**: `.guides/content/Level-3---Slot-Collection-a4b5/` — Units 0–8 and all section/lab pages are copied from the `level3/` files. Sync this chapter for the Level 3 TOC; do not maintain duplicate tutorial text in this guide.
...
1. **Student content**: `level3/Level3_Unit*_Content_*.md`, `level3/Level3_Lab*_Content.md`, and `.guides/content/Level-3---Slot-Collection-a4b5/`.
