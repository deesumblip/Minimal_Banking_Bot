...
|--------|--------|
| **Total Points** | **8** |
| **Instructor Provided Solution File** | `.guides/assessments/level3_graders/lab_4.1_solution_reference.md` (or `/home/codio/workspace/.guides/assessments/level3_graders/lab_4.1_solution_reference.md` if Codio requires absolute path) |
