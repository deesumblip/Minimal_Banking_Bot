...
You can define slots in the domain file, collect slots in flows, read slots in actions, handle missing or placeholder slot values, and create multi-turn conversations with memory.
