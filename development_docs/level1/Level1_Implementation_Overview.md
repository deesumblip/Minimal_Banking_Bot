...
- `Level1_Lab3.5_Assessment_Setup.md` – Lab 3.5 (Complete Your Agent for Training) – domain + hours/balance flows; grader: `lab_3.5_grader.py` (optional fill-in check: `lab_3.4_grader.py`)
...
- (Add others per course design: e.g. Lab 2.2, 2.3, 3.1–3.3, 4.1, 4.2, 5.1, 6.2, 6.3, 7.1)
