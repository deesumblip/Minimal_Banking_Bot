# Lab 3.5: Complete Your Agent for Training - Assessment Setup
...
Create or use a code-output-compare assessment with a unique taskId (e.g. `code-output-compare-350500005`) and attach it to the Lab 3.5 section in the Level 1 guide.
