...
Level 2 uses **7 units** (0–6): Recap → Introduction to Actions → Action Class → Create Action (Lab 3.1) → Register Actions (Lab 4.1) → Flows (Lab 5.1) → Training and wrap-up (Labs 6.1, 6.2, page 6.2, then **6.4** *See it all together*, then **6.5** *Before you continue*; former standalone Unit 7 and merged Unit 8 material are split across those two pages).
...
| `Level2_Unit6_Content_6.2_*.md` | Common training errors (testing/debugging guidance is in **Lab 6.2**); **Lab 6.1** is **`Level2_Lab6.1_Content.md`** only |
...
| 6.2 | Level2_Lab6.2_Content.md | Level2_Lab6.2_Assessment_Setup.md | code-output-compare-1597644299 | .guides/secure/level2_graders/lab_6.2_grader.sh |
