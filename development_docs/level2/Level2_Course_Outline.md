...
- 0.1 Your Level 1 Banking Agent
  ...
  - What's new in Level 2 (actions, starter vs labs, modified and unchanged files, configuration)
...
- **Unit 0**: `Level2_Unit0_Content_0.1_Your-Level-1-Banking-Agent.md` (Level 1 recap and Level 2 preview on one page)
