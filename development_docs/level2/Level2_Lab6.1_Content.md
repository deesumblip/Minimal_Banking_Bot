...
Submit the **Check It!** in the Codio guide once training has finished without errors and `level2/models/` contains a `.tar.gz` (assessment `code-output-compare-1070925386`).
