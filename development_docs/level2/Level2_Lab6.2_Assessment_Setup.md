...
Lab 6.2 is hands-on **Rasa Inspector** testing from **`level2/`** using `python -m rasa inspect --debug --log-file logs/logs.out`. Domain and training are assessed elsewhere (**Lab 4.1**, **Lab 6.1**).
