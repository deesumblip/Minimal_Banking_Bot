...
- **NLU and intents** — Refine intents and training data so the bot reliably triggers the right flows (e.g. transfer_money vs. transfer_money_tools).
- **Channels** — Connect the bot to a channel and test tool calling there.
