...
**Lab numbering:** Level 5 uses **Lab 2.0** (command-generator prompt; **code test** 10 points), then Labs 2.1, 3.1, 4.1, 5.1, 5.2. **Lab 2.0** wiring is also rechecked in **5.1 / 5.2** graders. **Lab 2.1** uses a **fill-in-the-blanks** exercise (5 points) plus the **code test** (10 points), matching the Chapter 1.4 Lab 0.1 pattern. Labs 3.1–5.2 use code tests only (10 points each). **Total graded points:** 65.
