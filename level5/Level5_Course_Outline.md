...
**Type**: Content Page | **Assessment**: None
**Sections**: 1.1 Tools vs Actions | 1.2 When to Use Tools
...
**Type**: Content Page | **Assessment**: None
**Sections**: 6.1 Complete Bot Walkthrough | 6.2 What You've Learned | 6.3 What's Next
**Key Concepts**: Level 5 summary; next steps (Level 6 sub-agents).
