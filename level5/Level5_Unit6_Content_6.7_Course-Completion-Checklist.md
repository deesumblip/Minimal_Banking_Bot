...
- **Train** the Level 5 bot from the `level5` folder (with venv activated at project root) and run the **completion check** (Lab 5.2)
- Optionally **test** the transfer_money_tools flow in Rasa Inspector and confirm tool-calling behavior

If you can do all of the above, you're ready for Level 6 or for extending your bot with more tools and flows.
