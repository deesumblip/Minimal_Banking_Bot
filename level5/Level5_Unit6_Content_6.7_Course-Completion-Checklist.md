...
- **Train** the Level 5 agent from the `level5` folder (with venv activated at project root) and run the **completion check** in the **last lab** of the training and testing unit
