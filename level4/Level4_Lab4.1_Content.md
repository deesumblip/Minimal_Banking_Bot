...
**`always_include_in_prompt`** / **`if`** help keep this flow visible to the command generator (see **`PIPELINE_CHAPTER_1_3_AND_4.md`**). Each **`collect:`** **`description:`** should stay **short** and clear. **Retrain** after saving.
