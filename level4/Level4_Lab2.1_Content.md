...
**Prerequisite:** **`level4/config.yml`** and **`level4/endpoints.yml`** match the Chapter 1.4 course pattern (see **Unit 0.3 Complete Delta**). If you only copied files from `level3/` without the pipeline updates, fix those **before** you rely on Inspector for free-text slots.
