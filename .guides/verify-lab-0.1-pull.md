...
grep -q "Set Up Your Own RASA_LICENSE" .guides/content/Chapter-1-1---Just-Responses-d3b4/Unit-0--Prerequisites-and-Setup-1039/Lab-0-1--Create-Virtual-Environment-and-Install-Rasa-Pro-4434.md && echo "Lab 0.1 content: OK"
...
grep -q "Step 4: Verifying RASA_LICENSE" .guides/assessments/level1_graders/lab_0.1_grader.py && echo "Grader Step 4: OK"
...
```bash
cd /home/codio/workspace
python3 .guides/assessments/level1_graders/lab_0.1_grader.py
```
