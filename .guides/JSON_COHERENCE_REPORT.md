...
- **Level 2 Unit 0:** `order` = `["0-1-Your-Level-1-Banking-Agent-2415"]` only (single page; no separate 0.2).
...
- **Level 2 Unit 6:** `order` is **`Lab-6-1--Training-and-Testing-with-Actions-7710`**, **`6-2-Common-Training-Errors-with-Actions-9733`**, **`Lab-6-2--Verify-Domain-and-Training-2289`**, **`6-4-Level-2-Wrap-Up-d798`**, **`6-5-Core-Ideas-and-Level-3-Readiness-b91a`**. Page JSON **titles**: **Lab 6.2: Training and Testing**, **6.4 See it all together**, **6.5 Before you continue**. **`6-4`** — integration walkthrough, project map, practices, **5×** MC **Check It!** (`multiple-choice-1208100001`–`0005`). **`6-5`** — brief L2 checkpoint and readiness; defers slot detail and Level 3 roadmap to Level 3 Unit 0 (no assessments). Removed stems: **`6-1-Training-with-Actions-c79c`** (merged into Lab 6.1); **`6-4-Debugging-Actions-6978`** (merged into Lab 6.2). **Separate Unit 7 removed:** former page **`7-1-Complete-Agent-Walkthrough-d798`** retired; former **7.2**/**7.3**-style material and **Unit 8** stems **`8-1-Knowledge-Check-9fc3`** through **`8-5-Course-Completion-Checklist-5f74`** now surface across **`6-4`** and **`6-5`**. Unit **`index.json`** title: **Unit 6: Training, Testing, and Level 2 Wrap-Up**.
