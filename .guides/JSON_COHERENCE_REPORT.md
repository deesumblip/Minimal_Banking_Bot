...
| 1.4 | 401020001, fill-in-the-blanks-401030010, 401030001, 401040001, 401050001, 401050002 | Present | Yes |
...
**Chapter 1.4:** Lab .md files under `Chapter-1-4---Multiple-Slots-e5f6/` include `{Check It!|assessment}(code-output-compare-40XXXXXX)` for Labs 2.1, 4.1, 5.1, 5.2; **Lab 3.1** also includes `fill-in-the-blanks-401030010` before the code test (parity with Ch 1.3 Lab 4.1). Coherent.
