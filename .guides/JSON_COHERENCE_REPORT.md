...
| 1.2 Custom Actions | Unit-0 … Unit-6 (7 units; Unit 6 ends with **6.4** integration + knowledge check, then **6.5** core ideas and Level 3 readiness) | Present | Yes |
...
- **Chapter 1.2 Unit 6:** `order` is **`Lab-6-1--Training-and-Testing-with-Actions-7710`**, **`6-2-Common-Training-Errors-with-Actions-9733`**, **`Lab-6-2--Verify-Domain-and-Training-2289`**, **`6-3-Testing-Your-Action-4ae9`**, **`6-4-Level-2-Wrap-Up-d798`**, **`6-5-Core-Ideas-and-Level-3-Readiness-b91a`**. **`6-4`** — integration walkthrough, project map, practices, **5×** MC **Check It!** (`multiple-choice-1208100001`–`0005`). **`6-5`** — brief L2 checkpoint and readiness; defers slot detail and Level 3 roadmap to Chapter 1.3 Unit 0 (no assessments). Removed stems: **`6-1-Training-with-Actions-c79c`** (merged into Lab 6.1); **`6-4-Debugging-Actions-6978`** (merged into **`6-3-Testing-Your-Action-4ae9`**). **Separate Unit 7 removed:** former page **`7-1-Complete-Agent-Walkthrough-d798`** retired; former **7.2**/**7.3**-style material and **Unit 8** stems **`8-1-Knowledge-Check-9fc3`** through **`8-5-Course-Completion-Checklist-5f74`** now surface across **`6-4`** and **`6-5`**. Unit **`index.json`** title: **Unit 6: Training, Testing, and Level 2 Wrap-Up**.
