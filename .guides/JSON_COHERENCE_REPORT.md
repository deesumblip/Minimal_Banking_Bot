...
- **Level 1 Unit 3:** `order` = `3-1-What-is-a-Flow--358e`, `Lab-3-1--Exploring-Existing-Flows-17b5`, `3-2-Flow-Structure-Deep-Dive-af70`, `Lab-3-2--Creating-Your-First-Flow-c824`, `Lab-3-3--Multi-Step-Flow-3938`, `3-3-Flow-Descriptions-and-LLM-Understanding-f72a`, `Lab-3-5--Flow-Descriptions-and-LLM-Matching-5cc1`, `Lab-3-6--Complete-Your-Agent-for-Training-c4f0`, `3-4--Test-Your-Knowledge-26ac`. Sidebar ends with **3.4 Test Your Knowledge** after **Lab 3.5** / **Lab 3.6** (see unit `index.json` `content`).
