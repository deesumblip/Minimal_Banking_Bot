...
**What you'll build**: In **Unit 3 / Lab 3.2** you'll create your own action (**action_holiday_hours**) that uses the current date—if today is a holiday it says we're closed today, otherwise it returns the general holiday schedule. In **Labs 4.1 and 5.1** you'll register it in the domain and add a flow for it.
