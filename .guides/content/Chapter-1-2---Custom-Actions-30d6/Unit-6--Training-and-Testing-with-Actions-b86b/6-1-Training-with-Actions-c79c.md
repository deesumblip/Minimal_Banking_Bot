...
After training, you can test the agent in the **Rasa Inspector GUI** using the questions in section 6.3. If you need a reminder of the training command or Inspector setup, see **Lab 6.2**.
