...
- [ ] Create a new action in Python (you did this in Lab 3.1 with `action_holiday_hours`)
- [ ] Register actions in the domain file (including your `action_holiday_hours`)
- [ ] Create a flow that uses an action (you created `holiday_hours.yml` for your action)
