...
Do not remove or change the existing sections (action_endpoint, nlg, model_groups). Just add the `tools:` block. In Lab 3.1 you will add this section and verify the bot can load the tools.
