...
**Next:** Read **3.4 Flow Descriptions and LLM Understanding** for how the `description` field helps the LLM match user messages to flows. Then apply that in **Lab 3.5** with the hours and balance fill-in exercises.
