...
Rasa will read your domain (including the new slots and ask responses), your flows (including `transfer_money`), and your actions (including `action_process_transfer`). When training finishes without errors, you can **in Codio** use **Check It!** for **Lab 5.1**, then test the transfer flow in Inspector (Lab 5.2).
