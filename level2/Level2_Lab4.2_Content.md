...
4. **Start and open the Rasa Inspector GUI.** From the `level2` folder with the virtual environment active, run `python -m rasa inspect --debug` in the terminal and leave it running. Then open the Inspector interface:
