...
Level 2 uses **8 units** (0–7): Recap → Introduction to Actions → Action Class → Create Action (Lab 3.1) → Register Actions (Lab 4.1) → Flows (Lab 5.1) → Training (Labs 6.1, 6.2) → Putting It All Together (wrap-up, review, and knowledge check on one page; former Unit 8 merged into Unit 7).
...
| `Level2_Unit6_Content_6.2_*.md`, `6.3_*.md` | Common training errors; testing and debugging (former **6.4** merged into **6.3**); **Lab 6.1** is **`Level2_Lab6.1_Content.md`** only |
| `Level2_Unit7_Content_7.1_*.md` | Putting it together, review, and wrap-up: walkthrough, structure, practices, **5× MC knowledge check**, limitations, Level 3 preview, checklist (**former 7.2–7.3 and Unit 8** merged into **7.1**) |
